  ...
  let events = [
    ...
    ["Isra Shadowfang", "Birth Of Isra", new Date(13045, 11, 21, 5), new Date(13045, 11, 21, 6)],
  ...
  let selectedCategories = ["World Events", "Coneenci", "Soup", "Isra Shadowfang", "Filler Character", "Filler Character 2"];
